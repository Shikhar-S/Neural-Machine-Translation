...
parser.add_argument('--input_vocab',type=int,default=5000)
parser.add_argument('--output_vocab',type=int,default=5000)
...
parser.add_argument('--training_data',type=str2tuple,default=('./Data/parallel/IITB.en-hi.en','./Data/parallel/IITB.en-hi.hi'))
